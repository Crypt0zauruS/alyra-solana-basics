...
export const getWalletAuthentication = async (
...
export const verifyEncodedMessage = async (
  wallet: WalletContextState,
  message: string,
...
export const initializeAccount = async (
  ...
  try {
    const accountTransaction = await getInitializeAccountTransaction(
...
export const getAccount = async (publicKey: PublicKey): Promise<any> => {
  try {
    ...
    const [accountPda] = PublicKey.findProgramAddressSync(
      [accountSeed, publicKey.toBuffer()],
...
export const getInitializeAccountTransaction = async (
  publicKey: PublicKey,
  data: BN,
  age: BN
...
export const getInitializeAccountTransactionWWithoutAnchor = async (
  publicKey: PublicKey,
  data: BN,
  age: BN
): Promise<Transaction | null> => {
...
// Allow to send a tip to a Jito random wallet to increase transaction speed
